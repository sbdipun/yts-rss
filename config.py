...
YTS_RSS_URL = os.getenv("RSS_URL", "https://yts.bz/rss/0/all/all/0/all")
...
TBL_BASE_URL = os.getenv("TBL_BASE_URL", "https://1tamilblasters.codes/")
TMV_BASE_URL = os.getenv("TMV_BASE_URL", "https://www.1tamilmv.army/")
...
SHARESPARK_RSS_URL = os.getenv("SHARESPARK_RSS_URL", "https://ww1.sharespark.cfd/index.php?action=.xml;type=rss")
